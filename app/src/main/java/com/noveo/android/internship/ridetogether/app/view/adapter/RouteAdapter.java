...
import com.noveo.android.internship.ridetogether.app.rest.model.route.Properties;
...
import com.noveo.android.internship.ridetogether.app.view.viewholder.CommentViewHolder;
import com.noveo.android.internship.ridetogether.app.view.viewholder.RouteViewHolder;
...
public class RouteAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void configureRouteViewHolder(RouteViewHolder holder, int position) {
        ...
        if (route != null) {
            ...
            holder.distance.setText(RouteUtil.getRouteDistance(route.getGeometry()));
